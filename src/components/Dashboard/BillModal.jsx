...
import { generateUniqueId } from "../../constants/constant";
...
const BillModal = ({
	...
	useEffect(() => {
		console.log(existingBill, "tets");
		if (existingBill) {
			setBill({
				...existingBill,
				invoiceNo: existingBill.invoiceNo || generateUniqueId("INV"),
				items: (
					existingBill.items || [
			...
			setBill({
				...
				notes: "",
				amount: 0,
				invoiceNo: generateUniqueId("INV"),
			});
		}
				...
				<div className="bg-white rounded-3xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
					<div className="sticky top-0 bg-white z-10 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
						<h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
							...
							{existingBill && !existingBill.isNew
								? "View/Edit Bill"
								: "Add New Bill"}
						</h2>
					...
					<form onSubmit={handleSubmit} className="p-6 space-y-8">
						...
						<div>
							...
							<textarea
								...
								placeholder="Add any notes for this bill..."></textarea>
						</div>
