  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="32 Pearls Dental Clinic | Professional Dental Care" />
        <meta property="og:description" content="32 Pearls Dental Clinic provides exceptional dental care with a team of experienced professionals using the latest technology." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://32pearlsdental.com" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="32 Pearls Dental Clinic | Professional Dental Care" />
        <meta name="twitter:description" content="32 Pearls Dental Clinic provides exceptional dental care with a team of experienced professionals using the latest technology." />
      </Helmet>
      <nav
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-12 sm:h-14 md:h-16">
            ...
            <div className="flex-shrink-0">
              <Link to="/" className="flex items-center transition-all duration-300 hover:scale-105" aria-label="32 Pearls Dental Clinic Home">
                <div className="flex items-center">
                  <div className="mr-1.5 sm:mr-2 flex items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 p-1 sm:p-1.5 shadow-md">
                    <Stethoscope className={`h-4 w-4 md:h-5 md:w-5 text-white`} aria-hidden="true" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xl md:text-2xl font-bold tracking-tight">
                      <span className={`${scrolled ? "text-indigo-700" : "text-white"}`}>32</span>
                      <span className={`${scrolled ? "text-indigo-400" : "text-indigo-300"}`}>•</span>
                      <span className={`${scrolled ? "text-purple-600" : "text-white"}`}>Pearls</span>
                    </span>
                    <span
                      className={`text-[10px] md:text-xs tracking-widest uppercase ${scrolled ? "text-purple-600" : "text-purple-200"}`}
                    >
                      Dental Clinic
                    </span>
                  </div>
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3">
              ...
              <div className="md:hidden flex items-center space-x-1.5">
                ...
                >
                  ...
                  {isOpen ? (
                    <X
                      className={`h-4 w-4 sm:h-5 sm:w-5 ${scrolled ? "text-gray-700" : "text-white"}`}
                      aria-hidden="true"
                    />
                  ) : (
                    <Menu
        ...
        >
          <div className="px-3 pt-3 pb-4 space-y-2 bg-white/95 backdrop-blur-md shadow-xl rounded-b-xl mx-2 md:mx-4 lg:mx-6 border border-indigo-100">
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`text-gray-500 ${social.hoverColor} transition-all duration-300 hover:scale-110 ${
                        isOpen ? `animate-fadeIn opacity-0` : ""
                      }`}
                      style={{
