          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-2 md:order-1 animate-fade-in-up">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-white mb-6">
                {service.title} <span className="text-purple-200">Excellence</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4 animate-fade-in-up animation-delay-900">
                {service.features.slice(0, 3).map((feature, idx) => (
                  <span key={idx} className="inline-flex items-center px-4 py-1.5 rounded-full bg-purple-200 text-purple-900 text-sm font-medium shadow-sm">
            ...
            <div className="order-1 md:order-2 relative z-10 flex justify-center animate-fade-in-up animation-delay-300">
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-full border-8 border-white/20 shadow-2xl">
                  <img
                    src={service.image || "https://images.unsplash.com/photo-1606811971618-4486d14f3f99?auto=format&fit=crop&w=600&h=600"}
                    alt={service.title}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="md:col-span-2">
              {/* About Section */}
              <div id="about-section" className="mb-16 scroll-mt-32 animate-fade-in-up">
                <div className="flex items-center mb-6">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br ${service.color} shadow-lg mr-4`}>
                    {service.icon}
                  </div>
                ...
                <div className="prose prose-lg max-w-none mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mt-4">
                    Our team of experienced dental professionals uses the latest technology and techniques to ensure 
                    that your {service.title.toLowerCase()} experience is comfortable, effective, and tailored to your 
                    specific needs. We take pride in providing personalized care that addresses your unique dental concerns.
                  </p>
                </div>

                <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
                  <h3 className="text-xl font-semibold text-indigo-900 mb-4">Why Choose Our {service.title} Service?</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-indigo-600 mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Experienced specialists with advanced training</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-indigo-600 mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">State-of-the-art equipment and techniques</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-indigo-600 mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Comfortable, patient-centered approach</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-indigo-600 mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Comprehensive care with attention to detail</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              {/* Features Section */}
              <div id="features-section" className="mb-16 scroll-mt-32 animate-fade-in-up">
                  ...
                  {service.features.map((feature, idx) => (
                    ...
                    >
                      <div className="flex items-start">
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center bg-gradient-to-br ${service.color} shadow-md mr-4 group-hover:scale-110 transition-transform`}>
                          <CheckCircle className="w-5 h-5 text-white" />
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-indigo-900 mb-2">Feature {idx + 1}</h3>
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-100">
                  <h3 className="text-xl font-semibold text-indigo-900 mb-4">Our Approach</h3>
                  <p className="text-gray-700 mb-4">
                    At DentalCare, we believe in a comprehensive approach to {service.title.toLowerCase()}. 
                    Our process begins with a thorough assessment of your dental health, followed by a 
                    personalized treatment plan designed to address your specific needs and goals.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 mt-6">
                    <div className="flex-1 bg-white p-4 rounded-lg shadow-sm">
                      <div className="flex items-center mb-2">
                        ...
                        <h4 className="font-semibold text-indigo-900">Assessment</h4>
                      </div>
                      <p className="text-sm text-gray-600">Comprehensive evaluation of your dental health</p>
                    </div>
                    <div className="flex-1 bg-white p-4 rounded-lg shadow-sm">
                      <div className="flex items-center mb-2">
                        <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center mr-3">
                        ...
                        <h4 className="font-semibold text-indigo-900">Planning</h4>
                      </div>
                      <p className="text-sm text-gray-600">Customized treatment plan for your needs</p>
                    </div>
                    <div className="flex-1 bg-white p-4 rounded-lg shadow-sm">
                      <div className="flex items-center mb-2">
                        <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center mr-3">
                        ...
                        <h4 className="font-semibold text-indigo-900">Treatment</h4>
                      </div>
                      <p className="text-sm text-gray-600">Expert care using advanced techniques</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Benefits Section */}
              <div id="benefits-section" className="mb-16 scroll-mt-32 animate-fade-in-up">
                <h2 className="text-2xl md:text-3xl font-bold text-indigo-900 mb-6">
                  Key Benefits
                </h2>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  {service.benefits.map((benefit, idx) => (
                    ...
                    >
                      <div className="flex items-start">
                        <div className={`w-10 h-10 rounded-full ${service.bgColor} flex items-center justify-center mr-4 group-hover:scale-110 transition-transform`}>
                          {idx === 0 && <Heart className={`w-5 h-5 ${service.accentColor}`} />}
                          {idx === 1 && <Shield className={`w-5 h-5 ${service.accentColor}`} />}
                          {idx === 2 && <Award className={`w-5 h-5 ${service.accentColor}`} />}
                          {idx === 3 && <Users className={`w-5 h-5 ${service.accentColor}`} />}
                          {idx > 3 && <span className={`font-bold ${service.accentColor}`}>{idx + 1}</span>}
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-indigo-900 mb-2">Benefit {idx + 1}</h3>
                ...
                <div className="mt-10 p-6 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl text-white">
                  <h3 className="text-xl font-semibold mb-4">Long-term Benefits</h3>
                  <p className="text-indigo-100 mb-6">
                    Investing in regular {service.title.toLowerCase()} services provides lasting benefits for your oral health:
                  </p>
                  <div className="grid sm:grid-cols-3 gap-4">
                    <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                      <h4 className="font-semibold mb-2">Improved Health</h4>
                      <p className="text-sm text-white/80">Better oral health contributes to better overall health</p>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                      <h4 className="font-semibold mb-2">Confidence Boost</h4>
                      <p className="text-sm text-white/80">A healthy smile enhances your confidence in social situations</p>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                      <h4 className="font-semibold mb-2">Cost Savings</h4>
                      <p className="text-sm text-white/80">Preventive care helps avoid expensive treatments later</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="md:sticky md:top-32 self-start">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-8 border border-gray-100 animate-fade-in-up animation-delay-600">
                ...
                <p className="text-gray-600 mb-6">
                  Schedule your {service.title.toLowerCase()} appointment today and take the first step towards a healthier smile.
                </p>
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="font-semibold text-indigo-900">(123) 456-7890</p>
                </div>
              </div>
